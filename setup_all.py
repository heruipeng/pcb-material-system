...
print('='*60)
for f_data in [{'code':'SZ01','name':'Shenzhen Plant 1','address':'No.100 XX Rd, Baoan','contact':'Mr. Zhang'},{'code':'SZ02','name':'Shenzhen Plant 2','address':'No.200 XX Rd, Longgang','contact':'Mr. Li'},{'code':'DG01','name':'Dongguan Plant','address':'No.88 XX Rd, Changan','contact':'Mr. Wang'}]:
...
for u_data, su, st in [({'username':'admin','role':'admin','department':'IT','factory':'SZ01'},True,True),({'username':'zhangsan','role':'manager','department':'Engineering','factory':'SZ01'},False,True),({'username':'lisi','role':'engineer','department':'Quality','factory':'SZ02'},False,False),({'username':'wangwu','role':'operator','department':'Production','factory':'DG01'},False,False),({'username':'zhaoliu','role':'viewer','department':'R&D','factory':'SZ01'},False,False)]:
...
for td in [('FP-001','Flying Probe A1','fly_probe','FLY_PROBE','2.1'),('FP-002','Flying Probe A2','fly_probe','FLY_PROBE','2.0'),('IMP-001','Impedance Analyzer B1','impedance','IMPEDANCE','1.5'),('AOI-001','AOI Inspector C1','aoi','AOI','3.0'),('AOI-002','AOI Inspector C2','aoi','AOI','3.1'),('XR-001','X-Ray Inspector D1','xray','XRAY','1.0')]:
...
for rd in [('RPT_Q001','Daily Quality Inspection','summary','QUALITY'),('RPT_Q002','Incoming Inspection Detail','detail','QUALITY'),('RPT_P001','Daily Output Summary','summary','PRODUCTION'),('RPT_P002','Process Efficiency Analysis','analysis','PRODUCTION'),('RPT_Y001','Overall Yield Statistics','statistical','YIELD'),('RPT_C001','Material Cost Accounting','analysis','COST')]:
